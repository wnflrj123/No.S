...
export default function Hero({ invite }: { invite: Invite }) {
  ...
  return (
    <section className="px-5 md:px-8 pt-8 md:pt-14 pb-4 md:pb-8">
      <div className="max-w-3xl mx-auto md:flex md:items-center md:gap-8">
        {/* 포스터 — 모바일 작은 thumbnail 중앙, 데스크탑 좌측 thumbnail */}
        <div className="mx-auto md:mx-0 w-32 md:w-56 shrink-0">
          <div className="aspect-[3/4] relative overflow-hidden rounded-xl bg-gray-100 shadow-md">
            <Image
